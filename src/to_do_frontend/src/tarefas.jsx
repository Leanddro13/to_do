...
function Tarefas() {
  ...
  useEffect(() => {
    ...
    atualizarTotalTarefasConcluidas();
  }, []);
  ...
  async function atualizarTotalTarefas() {
    const total = await to_do_backend.totalTarefasEmAndamento();
    setTotalTarefas(Number(total));
  }

  async function atualizarTotalTarefasConcluidas() {
    const total2 = await to_do_backend.totalTarefasConcluidas();
    setTotalTarefasConcluidas(Number(total2)); 
  }
  ...
  return (
    ...
    <main class="mt-[30px] mx-[30px]">
        ...
        <div class="flex total em andamento">
            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-black"> Total ({totalTarefas !== undefined ? totalTarefas : 0})</h5>                   
        </div>
        ...
        <div class="flex total concluida">
            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-black"> Total ({totalTarefasConcluidas !== undefined ? totalTarefasConcluidas : 0})</h5>                   
        </div>
